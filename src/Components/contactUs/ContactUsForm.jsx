...
const ContactUsForm = () => {
  ...
  return (
    ...
    <div>
        ...
        {
            errors.firstName && <span className=" text-blue-25">Enter Firstname *</span>
        }</div>
        ...
        {
            errors.lastName && <span className=" text-blue-25">Enter Lastname</span>
        }</div></div>
        ...
        {
            errors.email && <span className=" text-blue-25">Enter Email *</span>
        }</div>
        ...
        <div className='flex flex-col gap-2'>
            ...
            <div className='flex gap-5'>
                ...
                {
                    errors.phoneNo && <span className=" text-blue-25">{errors.phoneNo.message}</span>
                }
                </div>
            </div>
        </div>
        ...
        {
            errors.message && <span className=" text-blue-25">Enter your message *</span>
        }</div>

        <button type="submit" className="rounded-md bg-blue-50 px-6 py-3 text-center text-[13px] font-bold text-black shadow-[2px_2px_0px_0px_rgba(255,255,255,0.18)] transition-all duration-200 hover:scale-95 hover:shadow-none  disabled:bg-richblack-500 sm:text-[16px] ">Send Message</button>
